...
/**
 * Password reset page component that displays the password recovery form.
 * @param searchParams - Query parameters containing error or sent confirmation status
 * @returns The password reset page with recovery email form
 */
