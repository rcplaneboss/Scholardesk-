...
/**
 * School detail page wrapper component.
 * @param params - Route parameters containing the school ID
 * @returns The school detail page component
 */
...
/**
 * School detail component that displays school configuration, module access, and administrators.
 * @param params - Route parameters containing the school ID
 * @returns The school detail page with module toggles and admin information
 */
