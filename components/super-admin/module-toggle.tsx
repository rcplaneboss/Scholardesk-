...
/**
 * Module toggle component that displays a read-only toggle for school module access.
 * @param module - The module key (attendance, fees, or results)
 * @param enabled - Whether the module is enabled
 * @returns A read-only toggle UI showing module status
 */
